...
namespace WsdlUI.App.UI.UserControls {
    public partial class uc_TreeView : UserControlBase {
        ...
        public override void LoadSingleRequestMode() {
            ...
            mi_Add_Startup.Visible = false;
            mi_Remove.Visible = false;
            mi_Remove_Startup.Visible = false;

            tv_webServices.MouseDown -= new System.Windows.Forms.MouseEventHandler(this.tv_webServices_MouseDown);
        }
